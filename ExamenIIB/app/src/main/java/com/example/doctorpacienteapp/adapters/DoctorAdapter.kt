...
class DoctorAdapter(
    ...
    private val onViewLocationClick: (Doctor) -> Unit
    ...
    inner class DoctorViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val viewLocationButton: ImageButton = itemView.findViewById(R.id.viewLocationButton)
        ...
        fun bind(doctor: Doctor) {
            ...
            viewLocationButton.setOnClickListener { onViewLocationClick(doctor) }
        }
    }
